...
get_zone()
{
curl -s -X GET "https://api.Cloudflare.com/client/v4/zones/?per_page=101" -H "X-Auth-Email: $EMAIL" -H "X-Auth-Key: $KEY" -H "Content-Type: application/json"| jq -r '.result[] | "\(.id)"' >  "zoneid.txt"
